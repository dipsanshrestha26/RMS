...
namespace RMS.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public IActionResult CustomerTickets(string customerId)
        {
            ...
            ViewBag.ReportTitle = "Customer Tickets (Last 6 Months)";
            ViewBag.Report1 = dt;
            return View("Index");
        }
        ...
        public IActionResult HallShows(string hallId)
        {
            ...
            ViewBag.ReportTitle = "Hall Show Schedule";
            ViewBag.Report2 = dt;
            return View("Index");
        }
        ...
        public IActionResult Top3Occupancy(string movieId)
        {
            ...
            ViewBag.ReportTitle = "Top 3 Occupancy by Movie";
            ViewBag.Report3 = dt;
            return View("Index");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult RevenueByMovie(string movieId)
        {
            LoadDropdowns();
            ...
            var dt = _db.Query(@"
                SELECT m.MOVIE_TITLE,
                       ...
                       NVL(SUM(CASE WHEN p.PAYMENT_STATUS = 'Paid' THEN p.AMOUNT_PAID ELSE 0 END), 0) AS TOTAL_REVENUE
                FROM MOVIE_3NF m
                LEFT JOIN SHOW_3NF s ON s.MOVIE_ID = m.MOVIE_ID
                LEFT JOIN TICKET_3NF tk ON tk.SHOW_ID = s.SHOW_ID
                LEFT JOIN PAYMENT_3NF p ON p.TICKET_ID = tk.TICKET_ID
                WHERE m.MOVIE_ID = :MOVIE_ID
            ...
            ViewBag.ReportTitle = "Revenue by Movie";
            ViewBag.Report4 = dt;
            return View("Index");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult TicketStatusSummary()
        {
            LoadDropdowns();
            ...
            ViewBag.ReportTitle = "Ticket Status Summary";
            ViewBag.Report5 = dt;
            return View("Index");
        }
    }
