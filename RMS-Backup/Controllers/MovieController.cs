...
namespace RMS.Controllers
{
    public class MovieController : Controller
    {
        ...
        public IActionResult Create(string movieId, string movieTitle, string movieGenre, string movieLanguage, int movieDuration, DateTime releaseDate)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Update(string movieId, string movieTitle, string movieGenre, string movieLanguage, int movieDuration, DateTime releaseDate)
        {
            try
            {
